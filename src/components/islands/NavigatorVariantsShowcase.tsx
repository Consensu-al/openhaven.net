...
// Shared step subheader: numbered circle + title + subtitle as one tight unit
  ...
  return (
    <div className="flex items-center gap-3 mb-8">
      ...
      <div>
        ...
        <p className="text-sm leading-snug mt-0.5" style={{ color: 'var(--color-brand-text)', opacity: 0.55 }}>
          {subtitle}
        </p>
      </div>
    </div>
        ...
        {domains.slice(0, 6).map((domain) => {
          ...
          return (
            <button
              ...
              className="domain-card-btn group relative flex flex-col items-start rounded-2xl border-2 transition-all duration-200 cursor-pointer text-left"
              style={{
